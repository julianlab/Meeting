 ...
 */
class Version20190812111706 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE municipios CHANGE municipio municipio VARCHAR(70) NOT NULL, CHANGE slug slug VARCHAR(70) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE municipios CHANGE municipio municipio VARCHAR(255) NOT NULL COLLATE utf8_spanish_ci, CHANGE slug slug VARCHAR(255) NOT NULL COLLATE utf8_spanish_ci');
    }
}
